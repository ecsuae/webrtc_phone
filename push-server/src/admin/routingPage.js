 ...
 *
 * Accessible at http://10.252.253.15:8081/admin/routing (WireGuard-only).
...
function addPbxRow(domain, host, label) {
  ...
  tr.innerHTML = \`
    <td><input type="text" placeholder="fusn01.srve.cc" value="\${esc(d)}" class="pbx-domain"></td>
    <td><input type="text" placeholder="fusn01.srve.cc or 1.2.3.4" value="\${esc(h2)}" class="pbx-host"></td>
...
function addDomRow(domain, label) {
  ...
  const tr = document.createElement('tr');
  tr.innerHTML = \`
    <td><input type="text" placeholder="fusn01.srve.cc" value="\${esc(d)}" class="dom-val"></td>
