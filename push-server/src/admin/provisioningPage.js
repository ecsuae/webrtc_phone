...
function renderProvisioningPage({ accounts, devices }) {
  ...
  .admin-shell .provisioning-page .card{background:#1e293b;border:1px solid #334155;border-radius:8px;padding:16px;margin-bottom:14px}
  .admin-shell .provisioning-page table{width:100%;border-collapse:collapse;font-size:.85rem}
  .admin-shell .provisioning-page th{text-align:left;color:#64748b;font-weight:600;padding:6px 8px;border-bottom:1px solid #334155}
  .admin-shell .provisioning-page td{padding:6px 8px;border-bottom:1px solid #1e293b;vertical-align:top}
  .admin-shell .provisioning-page .muted{color:#64748b}
  .admin-shell .provisioning-page .warn-badge{display:inline-block;background:#713f12;color:#fde68a;border-radius:4px;padding:1px 7px;font-size:.75rem;margin-left:8px}
  .admin-shell .provisioning-page input[type=number]{background:#0f172a;border:1px solid #475569;border-radius:4px;color:#e2e8f0;padding:4px 8px;font-size:.84rem;width:88px;font-family:monospace}
  .admin-shell .provisioning-page input[type=text],.admin-shell .provisioning-page input[type=password]{background:#0f172a;border:1px solid #475569;border-radius:4px;color:#e2e8f0;padding:4px 8px;font-size:.84rem;width:100%;font-family:monospace}
  .admin-shell .provisioning-page input[type=checkbox]{transform:scale(1.05)}
  .admin-shell .provisioning-page .btn{padding:4px 10px;border:none;border-radius:5px;cursor:pointer;font-size:.82rem;font-weight:600;background:#1d4ed8;color:#fff}
  .admin-shell .provisioning-page .btn:disabled{background:#334155;color:#64748b;cursor:not-allowed}
  .admin-shell .provisioning-page .btn-secondary{background:#334155;color:#e2e8f0}
  .admin-shell .provisioning-page .btn-danger{background:#b91c1c;color:#fff}
  .admin-shell .provisioning-page .row-actions{display:flex;align-items:center;gap:10px;flex-wrap:wrap}
  .admin-shell .provisioning-page .row-msg{min-height:18px;font-size:.8rem}
  .admin-shell .provisioning-page .row-msg.ok{color:#4ade80}
  .admin-shell .provisioning-page .row-msg.err{color:#f87171}
  .admin-shell .provisioning-page .grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}
  .admin-shell .provisioning-page .field label{display:block;font-size:.78rem;color:#94a3b8;margin:0 0 4px 0}
  .admin-shell .provisioning-page .field{display:block}
  </style>`;

  const content = `<div class="provisioning-page">
  <div class="card">
  ...
  const scripts = CLIENT_SCRIPT;

  return renderAdminLayout({
    active: 'provisioning',
    title: 'Provisioning',
    subtitle: 'Provisioning accounts and provisioned devices.',
    content,
    headExtra,
    scripts,
  });
