...
| TASK-038 | Standalone plug-and-play deployment (mobi.srve.cc) — WireGuard + Let’s Encrypt | Active | 2026-04-30 | — | Make new VPS deployment reproducible: env-driven configs, Docker WireGuard, and Docker ACME cert issuance/renewal without exposing admin publicly. |
