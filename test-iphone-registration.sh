...
echo "1. Enable debug mode on iPhone at https://phone.srve.cc/"
...
while true; do
    ...
    curl -s http://10.252.253.15:8081/api/logs/mobile/metadata | \
    ...
    curl -s http://10.252.253.15:8081/api/logs/mobile/debug 2>/dev/null | \
