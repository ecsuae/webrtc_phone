...
import { startCall } from "../sipCall.js";
...
export async function joinConferenceFromPin({ el, st, ui, SIP, runOneTapEnableFlow }) {
  ...
  // Fill guest SIP credentials into existing registration flow.
