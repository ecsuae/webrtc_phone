...
export function desktopStatusBarSection() {
  return `
    <div class="status-bar">
      ...
      <button class="refresh-btn" id="logOffBtn" style="display:none;" onclick="console.log('[logout-click-runtime] actual power/logout clicked');document.getElementById('btnStop').click();" title="Log Off">
